...
const samples = {
  $comment:
    ...
    "The *RequestInputs sections hold the inputs the outputs were produced " +
    "from, so a reimplementation can replay the fixture without importing " +
    "this script's case tables.",
  openaiRequests: {},
  anthropicRequests: {},
  modelResolution: {},
  openaiRequestInputs: structuredClone(OPENAI_CASES),
  anthropicRequestInputs: structuredClone(ANTHROPIC_CASES),
};
